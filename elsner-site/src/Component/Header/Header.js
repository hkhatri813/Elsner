  ...
  <div className="custom-class">
    ...
    <div className="right-header">
      <div className="custom-menu">
        <ul className="menu">
          <li id="menu-item-18523" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-18523"><a href="https://www.elsner.com/about-us/"><span className="screen-reader-text">About Us</span></a></li>
          ...
          <li id="menu-item-18526" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-18526"><a href="/our-portfolio/"><span className="screen-reader-text">Our Work</span></a></li>
          <li id="menu-item-18527" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-18527"><a href="https://www.elsner.com/solutions/"><span className="screen-reader-text">Solutions</span></a></li>
          <li id="menu-item-20609" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-20609"><a href="https://www.elsner.com/blog/"><span className="screen-reader-text">Blog</span></a></li>
          <li id="menu-item-20642" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-20642"><a href="https://www.elsner.com/career/"><span className="screen-reader-text">Career</span></a></li>
          <li id="menu-item-18528" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-18528"><a href="https://www.elsner.com/magento-extension/"><span className="screen-reader-text">Store</span></a></li>
        </ul>
      </div>
